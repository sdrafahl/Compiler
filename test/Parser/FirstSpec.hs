...
spec = do
  describe "createFirstMap" $ do
    ...
    it  "Should create a First Mapping for case D" $ do caseDFirst `shouldBe` First (Data.Map.fromList [(Term (Terminal "("),Data.Set.fromList [Terminal "("]),(Term (Terminal ")"),Data.Set.fromList [Terminal ")"]),(Term (Terminal "+"),Data.Set.fromList [Terminal "+"]),(Term (Terminal "EOF"),Data.Set.fromList [Terminal "EOF"]),(Term (Terminal "\948"),Data.Set.fromList [Terminal "\948"]),(NonTerm (NonTerminal "Exp"),Data.Set.fromList [Terminal "+",Terminal "\948"]),(NonTerm (NonTerminal "Term"),Data.Set.fromList [Terminal "("])])
